...
public class ContactTesterAPI
{
	...
	try
	{
	   ...
	   List<String> tags;
	    ...
	    contact = contactApi.getContactFromEmail("annie@henry.com");
	    ...
	    contact.setContactField(FieldName.LAST_NAME, "Besant1");
	    contact.setLead_score(5);
	    contact.setCustomField("Date Of Joining", "Test Add Custom Field3");
	    ...
	    contactIds.add("5711914151706624");
	    contactIds.add("5637925890949120");
